...
#ifndef XMRIG_OCLMEOWPOWRUNNER_H
#define XMRIG_OCLMEOWPOWRUNNER_H
...
class MeowPow_CalculateDAGKernel;


class OclMeowPowRunner : public OclBaseRunner
{
public:
    XMRIG_DISABLE_COPY_MOVE_DEFAULT(OclMeowPowRunner)

    OclMeowPowRunner(size_t index, const OclLaunchData &data);
    ~OclMeowPowRunner() override;
...
private:
    ...
    MeowPow_CalculateDAGKernel* m_calculateDagKernel = nullptr;
...
#endif // XMRIG_OCLMEOWPOWRUNNER_H
