...
#ifndef XMRIG_OCLMERAKIRUNNER_H
#define XMRIG_OCLMERAKIRUNNER_H
...
class Meraki_CalculateDAGKernel;


class OclMerakiRunner : public OclBaseRunner
{
public:
    XMRIG_DISABLE_COPY_MOVE_DEFAULT(OclMerakiRunner)

    OclMerakiRunner(size_t index, const OclLaunchData &data);
    ~OclMerakiRunner() override;
...
private:
    ...
    Meraki_CalculateDAGKernel* m_calculateDagKernel = nullptr;
