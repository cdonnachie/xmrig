...
#ifndef XMRIG_OCLEVRPROGPOWRUNNER_H
#define XMRIG_OCLEVRPROGPOWRUNNER_H
...
class EvrProgPow_CalculateDAGKernel;


class OclEvrProgPowRunner : public OclBaseRunner
{
public:
    XMRIG_DISABLE_COPY_MOVE_DEFAULT(OclEvrProgPowRunner)

    OclEvrProgPowRunner(size_t index, const OclLaunchData &data);
    ~OclEvrProgPowRunner() override;
...
private:
    ...
    EvrProgPow_CalculateDAGKernel* m_calculateDagKernel = nullptr;
...
#endif // XMRIG_OCLEVRPROGPOWRUNNER_H
