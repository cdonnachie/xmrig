...
#ifndef XMRIG_CUDAMERAKIRUNNER_H
#define XMRIG_CUDAMERAKIRUNNER_H
...
class CudaMerakiRunner : public CudaBaseRunner
{
public:
    CudaMerakiRunner(size_t index, const CudaLaunchData &data);
...
#endif // XMRIG_CUDAMERAKIRUNNER_H
