...
#ifndef XMRIG_CUDAEVRPROGPOWRUNNER_H
#define XMRIG_CUDAEVRPROGPOWRUNNER_H
...
class CudaEvrProgPowRunner : public CudaBaseRunner
{
public:
    CudaEvrProgPowRunner(size_t index, const CudaLaunchData &data);
...
#endif // XMRIG_CUDAEVRPROGPOWRUNNER_H
