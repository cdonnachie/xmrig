...
#ifndef XMRIG_CUDAMEOWPOWRUNNER_H
#define XMRIG_CUDAMEOWPOWRUNNER_H
...
class CudaMeowPowRunner : public CudaBaseRunner
{
public:
    CudaMeowPowRunner(size_t index, const CudaLaunchData &data);
...
#endif // XMRIG_CUDAMEOWPOWRUNNER_H
