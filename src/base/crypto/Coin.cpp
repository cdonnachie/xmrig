...
static const CoinInfo coinInfo[] = {
    ...
    { Algorithm::MEOWPOW_MEWC,    "MEWC",     "Meowcoin",     0,      0,              BLUE_BG_BOLD(   WHITE_BOLD_S " meowcoin ") },
    { Algorithm::EVRPROGPOW_EVR,  "EVR",      "Evrmore",      0,      0,              BLUE_BG_BOLD(   WHITE_BOLD_S " evrmore ") },
    { Algorithm::MERAKI_TLS,      "TLS",      "Telestai",     0,      0,              BLUE_BG_BOLD(   WHITE_BOLD_S " telestai ") },
