...
public:
    ...
    inline size_t nonceSize() const                     { return (algorithm().family() == Algorithm::KAWPOW || algorithm().family() == Algorithm::MEOWPOW || algorithm().family() == Algorithm::EVRPROGPOW || algorithm().family() == Algorithm::MERAKI) ?  8 :  4; }
