...
#if defined XMRIG_ALGO_KAWPOW || defined XMRIG_ALGO_MEOWPOW || defined XMRIG_ALGO_GHOSTRIDER
...
#       if defined XMRIG_ALGO_KAWPOW || defined XMRIG_ALGO_MEOWPOW || defined XMRIG_ALGO_GHOSTRIDER
        ...
        if ((f == Algorithm::KAWPOW) || (f == Algorithm::MEOWPOW) || (f == Algorithm::GHOSTRIDER) || (m_coin == Coin::RAVEN) || (m_coin == Coin::MEWC)) {
